...
const TrafficeByDirection = () => {
      ...
      const options = {
        ...
        annotations: {
          points: [
            { x: "09:00", y: 18, marker: { size: 5, fillColor: "#fff" }, label: { text: "A", borderColor: "#dc3545", style: { background: "#fff", color: "#000" } } },
            { x: "09:15", y: 12, marker: { size: 5, fillColor: "#fff" }, label: { text: "B", borderColor: "#dc3545", style: { background: "#fff", color: "#000" } } },
            { x: "10:00", y: 17, marker: { size: 5, fillColor: "#fff" }, label: { text: "F", borderColor: "#dc3545", style: { background: "#fff", color: "#000" } } },
            { x: "10:30", y: 14, marker: { size: 5, fillColor: "#fff" }, label: { text: "C", borderColor: "#dc3545", style: { background: "#fff", color: "#000" } } },
            { x: "10:45", y: 10, marker: { size: 5, fillColor: "#fff" }, label: { text: "D", borderColor: "#dc3545", style: { background: "#fff", color: "#000" } } }
          ]
        }
      };
  ...
  return (
    <>
        <Chart
          ...
          type="bar"
          height={'100%'}
          className={"_chartTrafficeByDirectioncompo flex w-full !min-h-[0] h-fit!"}
        />
    </>
  );
};
