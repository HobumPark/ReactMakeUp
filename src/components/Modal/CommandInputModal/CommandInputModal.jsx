  ...
  return (
    ...
    >
      ...
      <div className="bg-white rounded-xl w-[48%] shadow-lg relative z-10 transition-transform duration-300 transform scale-95" 
        ...
        <div className="flex items-center justify-between w-full mb-6 rounded-t-xl bg-[#3b4e6c]" 
          ...
          <div className="modal-close cursor-pointer" onClick={onClose} 
            style={{ backgroundColor: "#3b4e6c", width: "40px", height: "40px", display: "flex", justifyContent: "center", alignItems: "center" }}>
        ...
        <div className="h-[700px] p-[30px] box-border flex justify-end gap-4">
          <button
            className="bg-[#3b4e6c] text-white rounded hover:bg-blue-600 cursor-pointer hover:opacity-80"
          ...
          <button
            className="bg-gray-300 text-black rounded hover:bg-gray-400 cursor-pointer hover:opacity-80"
            style={{ width: "120px", height: "60px" }}
            onClick={()=>cancelClick()}
          >
            취소
