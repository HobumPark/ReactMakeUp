    ...
    <div className="w-full p-5 bg-white shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded-b-lg">
        ...
        <div className={`${tabClass}`}
           onClick={() => setActiveTab("profile")}>
            <span>
            <li className={`text-[#6b7280] text-[20px] list-none ${activeTab === "profile" ? activeTabClass : "font-[500]"}`}>
                Profile
            </li>
            </span>
        ...
        onClick={() => setActiveTab("password")}>
            <span>
            <li className={`text-[#6b7280] text-[20px] list-none ${activeTab === "password" ? activeTabClass : "font-[500]"}`}>
                Password
            </li>
            </span>
